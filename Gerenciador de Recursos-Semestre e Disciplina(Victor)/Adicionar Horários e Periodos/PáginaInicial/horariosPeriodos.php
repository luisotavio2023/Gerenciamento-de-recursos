...
include_once("../conexao/conexao.php");
    ...
    $sql = "SELECT * FROM horarios ORDER BY cod_horario DESC";
...
<body>
  <div class="retangulo-fundo">
    ...
    <h1 class="title">Adicionar Horários e Periodos:</h1>
    <form method="POST" action="../processamentos/processahorario.php">
      ...
      <table class="table text-white table-bg">
            ...
            <tbody>
                ...
                while ($user_data = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td> 
                    <a class='btn btn-sm btn-primary' href='../Funções/edithorarios.php?cod_horario=$user_data[cod_horario]'>
