...
<head>
    ...
    <link rel="stylesheet" href="../PáginaInicial/semestre.css">
...
<body>
    <div class="retangulo-fundo">
        ...
        <h1 class="title">Editar Semestre:</h1>
        <form method="POST" action="../Funções/saveEditsemestre.php">
            ...
            <input type="hidden"name="cod_semestre" value="<?php echo $cod_semestre ?>">
            <button class="botao" type="submit" name="update">Salvar</button>
            ...
            <tbody>
                ...
                while ($user_data = mysqli_fetch_assoc($result)) {
                    ...
                    if ($user_data['situacao'] == 'ligado') {
                        echo "<button class='btn btn-sm btn-success' onclick='alternarEstado(this)'>ON</button>";
                    } else {
                        echo "<button class='btn btn-sm btn-danger' onclick='alternarEstado(this)'>OFF</button>";
                    }
                    echo "</td>";
                    ...
                    <a class='btn btn-sm btn-danger' href='../Funções/deletesemestres.php?cod_semestre=$user_data[cod_semestre]'>
